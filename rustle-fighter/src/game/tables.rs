...
pub const GEM_TABLES_COUNT: usize = 4;
...
/// `0x8016D81C`: four 64 entry weighted draws, values 1-4 for a plain gem of that colour and
/// 9-12 for its crash gem. Each favours two colours (12 entries) over the other two (7), and
/// all four hold 26 crash gems in 64 and 11 in their first 32 - so crash gems are 40.6% of the
/// first half's draw and 34.4% of the second's whichever table is in play.
